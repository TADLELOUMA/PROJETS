    ...
    <head>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name = "Confirmed_Password" id="Password" placeholder="Password" required></br>

                <input  type = "submit" class="btn btn-primary" value ="submit" />
                <a  class="btn btn-success" href="sigIn.php" style="float:right;">SigIn</a>
